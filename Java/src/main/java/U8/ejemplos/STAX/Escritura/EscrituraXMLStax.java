package U8.Ejemplos.STAX.Escritura;

import U8.Ejemplos.STAX.Pedido;
...
public class EscrituraXMLStax {
    public static void main(String[] args) {
        ...
        try {
            ...
            XMLEventWriter xmlWriter = xmlOutputFactory.createXMLEventWriter(new FileOutputStream("Ficheros/STAX/pedidos_nuevos.xml"));
