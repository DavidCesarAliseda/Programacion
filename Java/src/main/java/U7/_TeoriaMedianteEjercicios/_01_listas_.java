package U7._TeoriaMedianteEjercicios;
...
public class _01_listas_ {
  public static void main(String[] args) {
    ...
    // Comprobar si todos los elementos de "otra_lista" están en la "lista"
    lista.containsAll(otra_lista);

    // Añadir todos los elementos de "otra_lista" en "lista"
    lista.addAll(otra_lista);

    // Eliminar los elementos de "otra_lista" que están en "lista"
    lista.removeAll(otra_lista);

    // Elimina todos los elementos de "lista" salvo los que están en "otra_lista"
    lista.retainAll(otra_lista);
    ...
    // Guardar el elemento "elem" en la posición "indice", machando el elemento que había en esa
    // posición
    int indice = 2;
    ...
    lista.addAll(indice, otra_lista);
