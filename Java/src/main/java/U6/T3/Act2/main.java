...
public class main {
    ...
    el caso de error, así como la fecha y hora de ocurrencia. Cada vez que se ejecute el programa, se creará un
    fichero distinto (utiliza la fecha-hora actual como parte del nombre del fichero).
    Este fichero tendrá extensión .log
